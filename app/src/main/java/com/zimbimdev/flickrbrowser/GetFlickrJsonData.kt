...
class GetFlickrJsonData(private val listener: OnDataAvilable) : AsyncTask<String, Void, ArrayList<Photo>>() {

    private val TAG = "GetFlickrJsonData"

    interface OnDataAvilable {
        fun onDataAvilable(data: List<Photo>)
    ...
    override fun onPostExecute(result: ArrayList<Photo>) {
        ...
        listener.onDataAvilable(result)
